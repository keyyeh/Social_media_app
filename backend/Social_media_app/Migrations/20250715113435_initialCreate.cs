    ...
    public partial class initialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommPosts", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "int", nullable: false),
                    Content = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UserPComment = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PostComments_CommPosts_PostId",
                        column: x => x.PostId,
                        principalTable: "CommPosts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PostComments_PostComments_UserPComment",
                        column: x => x.UserPComment,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PostEmojis", x => new { x.PostId, x.UserId });
                    table.ForeignKey(
                        name: "FK_PostEmojis_CommPosts_PostId",
                        column: x => x.PostId,
                        principalTable: "CommPosts",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PostMedias_CommPosts_PostId",
                        column: x => x.PostId,
                        principalTable: "CommPosts",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Friendships_FriendshipId",
                table: "Friendships",
                column: "FriendshipId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostComments_UserPComment",
                table: "PostComments",
                column: "UserPComment");

            migrationBuilder.CreateIndex(
                name: "IX_PostEmojis_UserId",
                table: "PostEmojis",
                column: "UserId");
